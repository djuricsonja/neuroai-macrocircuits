"""Weight constraints, activation constraints and weight initializers for NCAP.

These are what encode the biological priors: a connection that is excitatory in
the C. elegans circuit stays excitatory under gradient descent, and so on.
"""
